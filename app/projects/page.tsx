  ...
  return (
    <div className="bg-[#fff] pt-22 pb-12">
      <div className="w-[95%] mx-auto">
        {/* page header */}
        <div className="flex flex-col medium:flex-row medium:items-end medium:justify-between mb-8">
          <h3 className="text-2xl text-black tracking-[.2rem] font-semibold mb-4 medium:mb-0">
            Projects
          </h3>
          {/* filters */}
        ...
        {hasMore && (
          <button
            ...
            className="mt-8 py-2 px-6 flex justify-center mb-10 mx-auto border border-black text-sm hover:bg-black hover:text-white transition-colors"
          >
            Load more
          </button>
        )}
