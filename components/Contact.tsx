        ...
        <div className='w-[95%] mx-auto mb-12'>
            ...
            <form action="">
                <div className='input-div flex-col mb-4'>
                    <label className='text-[13px]' htmlFor="">Name*</label>
                    <input type="text" name="" id="" className=''/>
                </div>
                <div className='input-div flex-col mb-4'>
                    <label className='text-[13px]' htmlFor="">Email address*</label>
                    <input type="email" name="" id="" />
                </div>
                <div className='input-div flex-col mb-8'>
                    <label className='text-[13px]' htmlFor="">Project description</label>
