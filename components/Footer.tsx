    ...
    <div className="flex items-center gap-4">
        {
            socials.map((social)=>{
                ...
                return(
                <Link key={social.id} href= {social.link} className="social-icon-wrapper text-white hover:bg-white hover:text-black transition-all duration-300">
  ...
  return (
    <div className="bg-black text-off-white flex-col-center pt-8 ">
        ...
        <div className=" flex-col-center gap-2 relative -bottom-8">
            <p className="text-xs opacity-70"> © {getCurrentYear()} All Rights Reserved. </p>
            <p className="font-nunito_sas tracking-[2rem] text-8xl opacity-10 ">KUN1E</p>
        </div>
    </div>
  );
};
